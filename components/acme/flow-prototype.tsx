...
import { FLOW } from "@/components/acme/flow-screens";

// `.acme-flow` でスコープされた screen のスタイル。
import "@/components/acme/flow.css";
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* `.acme-flow` でスコープした CSS を効かせる */}
          <div className="acme-flow">{children}</div>
