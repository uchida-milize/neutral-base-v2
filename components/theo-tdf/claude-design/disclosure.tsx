...
export const DISCLOSURE_INTRO = [
  ...
  { p: "各質問に対して「はい」に当てはまる場合はお申込みいただけません。" },
];
...
export const KO_CANCER = [
  ...
  { k: "がんについて", paras: [{ t: "今までに、がん（上皮内がん、肉腫、白血病、悪性リンパ腫、骨髄腫を含む）、高度異形成または骨髄異形成症候群になったことがありますか。" }] },
...
export const KO_ORDER = ["最近の健康状態", "健康診断・人間ドックについて", "病気・ケガについて", "がんについて", "身体の障がい・介護状態について", "女性の方"];
