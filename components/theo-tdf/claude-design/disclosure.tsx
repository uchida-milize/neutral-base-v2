...
export const KO_CARE = [
  ...
  { k: "身体の障がい・介護状態について", paras: [
    ...
    { t: "●現在、つぎの1〜5の日常生活のいずれかにおいて、他の方の介助またはご自身で補助具を必要とすることがある。＊骨折中などにより現在一時的に必要とする場合も含みます。\n＜1.歩行 2.衣服の着替え 3.入浴 4.食事 5.排泄＞" },
  ] },
];
// がん用
export const KO_CANCER = [
  ...
  { k: "健康診断・人⁠間⁠ド⁠ッ⁠クについて", paras: [{ t: "過去2年以内に健康診断・人⁠間⁠ド⁠ッ⁠クにおいて、以下の検査を受けて、異常の指摘を受けたことがありますか。" }, { t: "異常とは、要再検査・要精密検査・要治療をいいます。ただし、再検査・精密検査の結果、「異常なし」と診断された場合を除きます。" }], checks: ["■検査名", "『内視鏡検査・便潜血検査・マンモグラフィ検査』", "『腫瘍マーカー（CEA、AFP、CA19-9、PSA）』"] },
];
// 三大疾病用
export const KO_THREE = [
  ...
  { k: "病気・ケガについて", paras: [{ t: "過去5年以内に、病気で継続して7日以上の入院をしたことまたは手術を受けたことがありますか。（新⁠型⁠コ⁠ロ⁠ナ⁠ウ⁠イ⁠ル⁠スによる入院は含みません。）" }] },
  { k: "がんについて", paras: [{ t: "今までに、がん（上皮内がん、肉腫、白血病、悪性リンパ腫、骨髄腫を含む）、高度異形成または骨⁠髄⁠異⁠形⁠成⁠症⁠候⁠群になったことがありますか。" }] },
  { k: "健康診断・人⁠間⁠ド⁠ッ⁠クについて", paras: [{ t: "過去2年以内に健康診断・人⁠間⁠ド⁠ッ⁠クにおいて、以下の検査を受けて、異常の指摘を受けたことがありますか。" }, { t: "異常とは、要再検査・要精密検査・要治療をいいます。ただし、再検査・精密検査の結果、「異常なし」と診断された場合を除きます。" }], checks: ["■検査名", "『心電図検査・内視鏡検査・便潜血検査・マンモグラフィ検査』", "『腫瘍マーカー（CEA、AFP、CA19-9、PSA）』"] },
];
export const KO_ORDER = ["最近の健康状態", "健康診断・人⁠間⁠ド⁠ッ⁠クについて", "病気・ケガについて", "がんについて", "身体の障がい・介護状態について"];
