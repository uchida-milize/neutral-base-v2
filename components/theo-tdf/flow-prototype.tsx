...
import { FLOW } from "@/components/theo-tdf/flow-screens";

// `.theo-tdf-flow` でスコープされた screen のスタイル。
import "@/components/theo-tdf/flow.css";
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* `.theo-tdf-flow` でスコープした CSS を効かせる */}
          <div className="theo-tdf-flow">{children}</div>
