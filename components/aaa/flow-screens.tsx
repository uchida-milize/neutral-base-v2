...
import { FLOW_META } from "@/components/aaa/flow-meta";
 ...
 *
 * スタイルは `components/aaa/flow.css` を `.aaa-flow` でスコープ化。
 * 全画面の最上位ラッパー `<div className="phone">` の親に `aaa-flow` を
          ...
          {PRODUCTS.filter((p) => p.selected).map((p) => (
            ...
            >
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <span style={{ fontFamily: "var(--font-mono)", fontSize: 15, fontWeight: 800, color: "var(--primary-color-500)" }}>
          ...
          {["表面", "厚み", "セルフィー"].map((label, i) => (
            <div
              ...
              style={{
                ...
                height: 4,
                borderRadius: 2,
                background: i <= phase || phase === 3 ? "var(--primary-color-500)" : "var(--background-3)",
      ...
      <div className="screen">
        ...
        <div className="card">
          ...
          <div className="kv">
            ...
            <div className="row"><span className="k">月額保険料</span><span className="v" style={{ color: "var(--primary-color-500)" }}>¥806 / 月</span></div>
          </div>
        </div>
