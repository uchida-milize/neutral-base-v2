...
export default function Home() {
  return (
    <main className="min-h-screen bg-background text-foreground transition-colors duration-300 ease-out">
        {/* ------- Header ------- */}
        <header className="border-b border-stroke-default">
          <div className="mx-auto flex max-w-5xl items-center justify-between p-6">
            <div>
              ...
              <p className="text-fg-muted text-body mt-1">
                Figma Variables ベースの shadcn/ui コンポーネント一覧
              </p>
            </div>
            <ThemeToggle />
          </div>
