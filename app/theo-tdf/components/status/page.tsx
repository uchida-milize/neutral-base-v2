...
export const metadata: Metadata = { title: "ステータス | Components | THEO × T&Dファイナンシャル" };
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 pb-24 pt-10 sm:px-6 lg:pt-14">
      ...
      <header className="mb-10 max-w-3xl">
        ...
        <h1 className="mt-2 text-display-3 font-semibold tracking-tight">ステータス</h1>
        <p className="mt-3 text-body text-muted-foreground">処理結果を伝える StatusIcon。6 種類の状態に対応。</p>
      </header>
      <div className="mb-14 overflow-x-auto"><StatusSection /></div>
      <Section>
        <SectionHeading eyebrow="Props Reference" title="使い方早見表" description="StatusIcon の props 一覧。" audience="developer" />
