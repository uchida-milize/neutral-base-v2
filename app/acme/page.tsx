  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-[1400px] px-4 pt-10 sm:px-6 lg:pt-14">
        <section className="relative overflow-hidden rounded-2xl bg-[#0f766e] text-white transition-colors duration-300">
          <div
            aria-hidden
            className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(217, 119, 6, 0.35),transparent_55%)]"
          />
      ...
      <main className="mx-auto max-w-5xl px-4 pb-24 pt-12 sm:px-6">
        <OverviewSection
          guidelinesHref="/acme/guidelines"
          tenant="XXX (架空サンプル)"
        />
