...
function SectionHeading({
  ...
  return (
    <header className="mb-8 max-w-3xl">
      ...
      <h2 className="mt-2 text-h5 font-semibold tracking-tight sm:text-h4">
        {title}
      </h2>
...
const PILLARS = [
  ...
  },
  {
    icon: PaletteIcon,
    title: "モダン (Modern)",
    body: "Figma Variables ベースのトークン駆動。tenant override は --primary-blue-* と --navigation-navy-* に集約され、semantic 層は触らない。",
  },
  {
    icon: EyeIcon,
    title: "クリーン (Clean)",
  ...
  return (
    <Section id="color">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <ScaleBlock
          title="navigation-navy"
          subtitle="Primary brand · ボタン primary · sidebar · active nav"
          stops={[
            { name: "10", hex: "#eef0f6", inv: false },
            { name: "50", hex: "#dfe3ec", inv: false },
            { name: "100", hex: "#b3bbcd", inv: false },
        ...
        <ScaleBlock
          title="primary-blue"
          subtitle="Info / link / secondary action"
          stops={[
            { name: "10", hex: "#eff5ff", inv: false },
            { name: "50", hex: "#e2ecfb", inv: false },
            ...
            <Table>
              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell className="font-mono text-caption">navigation-navy-500</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>リンク / Info</TableCell>
                  <TableCell><code>--text-link</code> / <code>--text-info</code></TableCell>
                  <TableCell className="font-mono text-caption">primary-blue-500</TableCell>
                </TableRow>
                <TableRow>
      ...
      <div className="mt-6 rounded-lg border border-border bg-card p-5 text-card-foreground transition-colors duration-300">
        ...
        <p className="mt-2 text-body text-muted-foreground">
          顧客企業が変えるのは <code>--primary-blue-*</code> と{" "}
          <code>--navigation-navy-*</code>、そしてロゴアセットだけ。Semantic 層
...
function ScaleBlock({
  ...
  return (
    <Card className="overflow-hidden transition-colors duration-300">
      ...
      <CardContent>
        <div className="grid grid-cols-9 overflow-hidden rounded-md border border-border">
          {stops.map((s) => (
            <div
              key={s.name}
