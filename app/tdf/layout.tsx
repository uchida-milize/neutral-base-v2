...
// T&D 専用トークンを読み込む。.tdf-scope 配下でのみ shadcn セマンティック層が
 ...
 *   コンポーネントが自動的に T&D 色 (navy primary 等) を吸い込む
 * - SiteHeader もこのラッパー内に置くので、ヘッダーの primary 色も
 *   T&D 仕様に追従する
 * - 顧客視点: T&D 担当者には /tdf/ 配下の URL だけを案内し、
 *   ヘッダーには汎用 (/components /guidelines /prototype) への動線を出さない
 *   (site-header.tsx が path 判定して T&D ナビセットだけを出す)
 */
