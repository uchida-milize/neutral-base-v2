...
export const metadata: Metadata = {
  ...
  description:
    "XXX 仕様 (teal primary / cta-amber / warm) で描画されたコンポーネントカタログ。同じカタログを汎用版と比較すると、テナント差し替え点が一目で分かる。",
};
    ...
    <main className="mx-auto max-w-5xl px-4 pb-24 pt-10 sm:px-6 lg:pt-14">
      ...
      <header className="mb-8 max-w-3xl">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <Badge variant="secondary">primary = teal</Badge>
          <Badge variant="outline">cta = amber #d97706</Badge>
          <Badge variant="outline">warm = #fafaf9</Badge>
        </div>
      </header>
